...
finden Sie in der <a href="http://leafletjs.com/reference#marker">Leaflet Dokumentation</a>.
...
Analog zum Beispiel im Kapitel [Layergruppen]() sehen Sie im 
...
Wenn Sie ein `FeatureGroup`-Objekt mit Inhalt mit einem Mausklick entfernen möchten, 
